...
namespace HomeBillings.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Register([FromBody] UserRegister userRegister)
        {
            ...
            {
                AddNotificationError(error.Description);
            }
        ...
        public async Task<ActionResult> Login(UserLogin userLogin)
        {
            ...
            {
                AddNotificationError("Usuário temporariamente bloqueado por muitas tentativas inválidas.");
                return CustomResponse();
            }

            if (result.IsNotAllowed)
            {
                AddNotificationError("Usuário não possui acesso");
                return CustomResponse();
            }

            AddNotificationError("Usuário ou senha incorretos");
            return CustomResponse();
        }
        ...
        private string EncodeToken(ClaimsIdentity identityClaims)
        {
            ...
            var token = tokenHandler.CreateToken(new SecurityTokenDescriptor
            {
                ...
                Audience = _appSettings.ValideIn,
